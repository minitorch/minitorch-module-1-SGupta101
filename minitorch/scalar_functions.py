...
import minitorch
from minitorch.operators import sigmoid_back
...
class Inv(ScalarFunction):
    ...
    def forward(ctx: Context, a: float) -> float:
        # TODO: Implement for Task 1.2.
        ctx.save_for_backward(a)  # Only save the relevant input
        return 1.0 / a
...
class Sigmoid(ScalarFunction):
    ...
    def backward(ctx: Context, d_output: float) -> float:
        # TODO: Implement for Task 1.4.
        a = ctx.saved_values[0]  # Ensure a is extracted from the tuple
...
class Exp(ScalarFunction):
    ...
    def backward(ctx: Context, d_output: float) -> float:
        # TODO: Implement for Task 1.4.
        a = ctx.saved_values[0]  # Extract the single value from the tuple
